...
const storedVesselSchedule: StoredVesselSchedule = {
  ...
  portCalls: [{
    ...
    port: {
      unLocode: 'FAKE3',
      name: 'Fake port 3', // move to earlier than #2
    },
    isDeleted: false
  }, {
    id: '4',
    ...
    port: {
      unLocode: 'FAKE1',
      name: 'Fake port 1', // move 2 days earlier
    },
    isDeleted: false
  }, {
    id: '5',
